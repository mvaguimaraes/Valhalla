...
<?php
	...
	if (!$banco)
		...
		$query = mysql_query ("SELECT * FROM gerente WHERE CodGerente =".$_GET['gerente']);
...
<fieldset>
    <h1>Visualizar Gerente </h1><br><br>
    
    <h3>Dados Principais</h3><br><br>
				<b>Nome:</b><br>
				<?php echo $row['NomeGerente']; ?><br /><br>
    ...
    <br/>
			...
			<form name="form2" method="post" action="gerente_editar_gerente1.php">
			<input type="hidden" name="campocod" value=<?php echo $row['CodGerente']?> >
			<input type="submit" value="Editar"></form>
			
			<form name="form3" method="post" action="gerente_excluir_gerente1.php">
			<input type="hidden" name="campocodigo" value=<?php echo $row['CodGerente']?> >
