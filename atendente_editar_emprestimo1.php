...
{?>
	...
	<form method="post" action="atendente_editar_emprestimo.php" >
    <input type="hidden" name="id" value="<?php echo $row['CodEmprestimo']; ?>" />
    <fieldset>
    <h1>Editar Empr&eacute;stimo</h1><br><br>
    ...
    Atendente:<br>
				...
				Data do Empr&eacute;stimo:<br>
				<input type="date" required name="dataemp" value="<?php echo $row['DataEmprestimo'];?>" pattern="[0-9]{8}"  maxlength="8" placeholder="dia/m&ecirc;s/ano (só n&uacute;meros)"  /><br /><br>
