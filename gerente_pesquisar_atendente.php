...
<div>
			...
			<form name="form1" method="post" action="gerente_pesquisar_atendente.php">
			<fieldset>
				<h1>Pesquisar Atendente</h1><br><br>
			...
			<fieldset>
				...
				<table id="tabelafundo"><form>
					...
					<?php
					$query = mysql_query ("SELECT * FROM atendente WHERE NomeAtendente LIKE '%$camponome%'");
					...
					<tr>
						...
						<td><a href="gerente_visualizar_atendente.php?atendente=<?php echo $row['CodAtendente']?>" ><?php echo $row['NomeAtendente'];?></a></td>
