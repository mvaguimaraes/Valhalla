...
<div>
			...
			<form name="form1" method="post" action="gerente_pesquisar_emprestimo.php">
			<fieldset>
			...
			<fieldset>
				...
				<table id="tabelafundo"><form>
					...
					$query = mysql_query ("SELECT * FROM emprestimo WHERE DataEmprestimo between '$dataini' AND '$datafim' AND Situacao = 'Andamento';");
					...
					<tr>
						<td><a href="gerente_visualizar_emprestimo.php?emprestimo=<?php echo $row['CodEmprestimo']?>" ><?php echo $row['CodEmprestimo'];?></a></td>
