...
$result= mysql_query("SELECT * FROM  `gerente` WHERE  `CodGerente` = $campocod");

while($row= mysql_fetch_array($result))
{?>
	
	<form method="post" action="gerente_editar_gerente.php" >
    <input type="hidden" name="id" value="<?php echo $row['CodGerente']; ?>" />
    <fieldset>
    <h1>Alterar Gerente </h1><br><br>
    
    <h3>Dados Principais</h3><br><br>
				Nome:<br>
				<input type="text" name="nome" value="<?php echo $row['NomeGerente']; ?>"  maxlength="60" size="60"/><br /><br>
