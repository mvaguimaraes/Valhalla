...
<?php
	...
	if (!$banco)
		...
		$query = mysql_query ("SELECT * FROM atendente WHERE CodAtendente =".$_GET['atendente']);
...
<fieldset>
    <h1>Visualizar Atendente </h1><br><br>
    
    <h3>Dados Principais</h3><br><br>
				<b>Nome:</b><br>
				<?php echo $row['NomeAtendente']; ?><br /><br>
				...
				<b>Rua:</b><br>
				<?php echo $row['Rua']; ?><br /><br>
				
				<b>N&uacute;mero:</b><br>
				<?php echo $row['Numero']; ?><br /><br>

				<b>Complemento:</b><br>
				<?php echo $row['Complemento']; ?><br /><br>

				<b>Bairro:</b><br>
				<?php echo $row['Bairro']; ?><br /><br>

				<b>CEP:</b><br>
				<?php echo $row['CEP']; ?><br /><br>

				<b>Cidade:</b><br>
				<?php echo $row['Cidade']; ?><br /><br>		
				
				<b>Estado:</b><br>
				<?php echo $row['Estado']; ?><br /><br>	  
									
				<h3>Dados de Acesso</h3><br><br>
				<b>Usu&aacute;rio:</b><br>
				<?php echo $row['Usuario'];?><br /><br>
    ...
    <br/>
			...
			<form name="form2" method="post" action="gerente_editar_atendente1.php">
			<input type="hidden" name="campocod" value=<?php echo $row['CodAtendente']?> >
			<input type="submit" value="Editar"></form>
			
			<form name="form3" method="post" action="gerente_excluir_atendente1.php">
			<input type="hidden" name="campocodigo" value=<?php echo $row['CodAtendente']?> >
