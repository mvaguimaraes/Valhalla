...
<br><br><a href="atendente_reserva.php"><input type="submit" value="Reservar"></a>
			<form name="form2" method="post" action="atendente_editar_filme1.php">
			<input type="hidden" name="campocod" value=<?php echo $row['CodFilme']?> >
			<input type="submit" value="Editar"></form>
			
			<form name="form3" method="post" action="atendente_excluir_filme1.php">
			<input type="hidden" name="campocodigo" value=<?php echo $row['CodFilme']?> >
