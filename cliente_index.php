...
<div class="mainmen">
		...
		<a href='' title='Abstract'><img src='./imgs/pre5.jpg' /></a>-->
								...
								<a href="cliente_visualizar_filme.php?filme=<?php echo $row['CodFilme']?>"><?php echo "<img src='capas/".$row["Foto"]."'/></a>";?>
	...
	for($i=0; $i<sizeof($fotos); $i+=3){ ?>
		...
		<?php for($j=0; $j<3; $j++){ ?>
			...
			<td align="center"><a href="cliente_visualizar_filme.php?filme=<?php echo $fotos[$i+$j]['CodFilme']?>"><?php echo "<img src='capas/".$fotos[$i+$j]["Foto"]."'/></a><br>";?>
