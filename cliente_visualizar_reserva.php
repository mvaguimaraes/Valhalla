...
<?php
	...
	if (!$banco)
		...
		$query = mysql_query ("SELECT * FROM reservacliente WHERE CodReservaCliente =".$_GET['reservacliente']);
...
<fieldset>
    <h1>Visualizar Reserva do Cliente</h1><br><br>
    ...
    <br/>
			...
			<form name="form2" method="post" action="cliente_editar_reserva_cli1.php">
			<input type="hidden" name="campocod" value=<?php echo $row['CodReservaCliente']?> >
			<input type="submit" value="Editar"></form>
			
			<form name="form3" method="post" action="cliente_excluir_reserva_cli.php">
			<input type="hidden" name="campocodigo" value=<?php echo $row['CodReservaCliente']?> >
			<input type="submit" value="Excluir"></form><br><br><br><br><br><br><br>	
