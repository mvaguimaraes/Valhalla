...
$result= mysql_query("SELECT * FROM  `atendente` WHERE  `CodAtendente` = $campocod");

while($row= mysql_fetch_array($result))
{?>
	
	<form method="post" action="gerente_editar_atendente.php" >
    <input type="hidden" name="id" value="<?php echo $row['CodAtendente']; ?>" />
    <fieldset>
    <h1>Alterar Atendente </h1><br><br>
    
    <h3>Dados Principais</h3><br><br>
				Nome:<br>
				<input type="text" name="nome" value="<?php echo $row['NomeAtendente']; ?>"  maxlength="60" size="60"/><br /><br>
