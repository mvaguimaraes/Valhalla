...
{?>
	...
	<form method="post" action="atendente_reserva_at_finalizar1.php" >
    <input type="hidden" name="id" value="<?php echo $row['CodReservaAtendente']; ?>" />
	<fieldset>
    <h1>Finalizar Reserva Atendente </h1><br><br>
    
				<b>Atendente:</b><br>
				<?php echo $row['CodAtendente']; ?><br /><br>
				<input type="hidden" name="atendente" value="<?php echo $row['CodAtendente']; ?>" />
