...
echo "<script>alert('Todos os exemplares desse filme ja foram alugados!');top.location.href='atendente_index.php';</script>";
}
	...
	echo "<script>alert('O emprestimo foi realizado com sucesso!');top.location.href='atendente_index.php';</script>";
}
