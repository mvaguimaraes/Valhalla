...
$result= mysql_query("SELECT * FROM  `reservaatendente` WHERE  `CodReservaAtendente` = $campocod");

while($row= mysql_fetch_array($result))
{?>
	
	<form method="post" action="atendente_editar_reserva_at.php" >
    <input type="hidden" name="id" value="<?php echo $row['CodReservaAtendente']; ?>" />
    <fieldset>
    <h1>Editar Reserva Atendente </h1><br><br>
    
    Atendente:<br>
			
				<select name="atendente" id="atendente" value="<?php echo $row['CodAtendente'];?>" style="min-width:393px">
				<?php
					include ("conexao.php");
				...
				<select name="nomecli" id="nomecli" value="<?php echo $row['CodCliente'];?>" style="min-width:393px">
				<?php
					include ("conexao.php");
				...
				<select name="filme" id="filme" value="<?php echo $row['CodFilme'];?>" style="min-width:393px">
				<?php
					include ("conexao.php");
				...
				Data Requisitada:<br>
				<input type="date" required name="datareq" value="<?php echo $row['DataRequisitada'];?>" pattern="[0-9]{8}"  maxlength="8" placeholder="dia/m&ecirc;s/ano (só n&uacute;meros)"  /><br /><br>
				Data da Reserva:<br>
				<input type="date" required name="datares" value="<?php echo $row['DataFeitaReserva'];?>" pattern="[0-9]{8}"  maxlength="8" placeholder="dia/m&ecirc;s/ano (só n&uacute;meros)"  /><br /><br>	
