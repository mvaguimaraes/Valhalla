...
<br><br><a href="gerente_reserva.php"><input type="submit" value="Reservar"></a><br><Br>
			<form name="form2" method="post" action="gerente_editar_filme1.php">
			<input type="hidden" name="campocod" value=<?php echo $row['CodFilme']?> >
			<input type="submit" value="Editar"></form>
			
			<form name="form3" method="post" action="gerente_excluir_filme1.php">
