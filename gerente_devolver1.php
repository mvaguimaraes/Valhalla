...
if (!$banco)
	...
	function diasEntre($dataInicial, $dataFinal)
	{
	 ...
	 mysql_query("UPDATE  `valhalla`.`filme` SET `Quantidade`='$qtdatual' WHERE  `Nome` = '$filme';");
         ...
         echo "<script>alert('O filme ".$filme." foi devolvido com sucesso, o valor da operacao foi: R$".$precofinal."!');top.location.href='gerente_index.php';</script>";
		 /*echo 'O filme&nbsp;'; 
		 echo $filme; 
		 echo '&nbsp;foi devolvido com sucesso, o valor da operacao foi:&nbsp;'; 
		 echo $precofinal; 
		 echo '&nbsp;reais!';*/
