...
<div>
			...
			<fieldset>
				...
				<table id="tabelafundo"><form>
					...
					<?php
					$query = mysql_query ("SELECT * FROM gerente WHERE NomeGerente LIKE '%$camponome%'");
					...
					<tr>
						<td><?php echo $row['CodGerente'];?></td>
						<td><a href="gerente_visualizar_gerente.php?gerente=<?php echo $row['CodGerente']?>" ><?php echo $row['NomeGerente'];?></a></td>
