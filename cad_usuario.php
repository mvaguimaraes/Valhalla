...
{
  echo "<script>alert('Usuario ja existe!');top.location.href='gerente_cad_usuario.php';</script>";
} 
else{ 
	if($senha != $confsenha){
	echo "<script>alert('As senhas inseridas nao sao iguais!');top.location.href='gerente_cad_usuario.php';</script>";
	}
...
echo "<script>alert('Seu cadastro foi realizado com sucesso!');top.location.href='gerente_index.php';</script>";
...
$query = "INSERT INTO `valhalla`.`atendente` (`CodAtendente` ,`NomeAtendente` ,`CPF` ,`Telefone` ,`Email` ,`Rua` ,`Numero` ,`Complemento` ,`Bairro` ,`CEP` ,`Cidade` ,`Estado` ,`Usuario` ,`Senha`,`ConfirmaSenha`)
VALUES (NULL , '$nome', '$cpf', '$telefone', '$endemail', '$rua', '$numero', '$complemento', '$bairro', '$cep', '$cidade', '$estados', '$usuario', '$senha','$confsenha')";
...
$query = "INSERT INTO `valhalla`.`gerente` (`CodGerente` ,`NomeGerente` ,`CPF` ,`Telefone` ,`Email` ,`Rua` ,`Numero` ,`Complemento` ,`Bairro` ,`CEP` ,`Cidade` ,`Estado` ,`Usuario` ,`Senha`,`ConfirmaSenha`)
VALUES (NULL , '$nome', '$cpf', '$telefone', '$endemail', '$rua', '$numero', '$complemento', '$bairro', '$cep', '$cidade', '$estados', '$usuario', '$senha','$confsenha')";
