...
<div >
			...
			<form name="form1" method="post" action="emprestimo_atendente.php">
			<fieldset>
				<h1>Empr&eacute;stimo</h1><br><br>
				
				<!--Atendente:<br>
				<input type="text" name="atendente" id="atendente"  maxlength="60" size="60" required/><br /><br>-->
				...
				<?php
					...
					while($linhas = mysql_fetch_array($resultado))
					{
						...
						//$quantidade = ($linhas['Quantidade'] == $_POST['Quantidade'])?'selected':'';
				...
				<input type="date" required name="dataemp" pattern="[0-9]{8}"  maxlength="8" placeholder="dia/m&ecirc;s/ano (só n&uacute;meros)"  /><br /><br>
