...
<!--<script type='text/javascript' src="./js/gerarPaginacaoEqip.js"></script>-->
...
<div>
			...
			xmlhttp.onreadystatechange = function(){
				if(xmlhttp.readyState==4) {
					...
					document.getElementById("tabela").innerHTML= "<center><img src='images/Carreg.gif'></center>";
				}
			}
			var url="";
			...
			<fieldset>
				<h1>Pesquisar Filme</h1><br><br>
				<!--<p>C&oacute;digo <input type="text" name="campocodigo" size="8" maxlength="10"/>
				<i>ou</i>--> 
				<h3>Nome
				<input type="text" name="camponome" id="camponome" size="68" maxlength="250"/>
				<input type="submit" value="Buscar" onclick="gerarPaginacao(1)"></h3>
				</p>
			</fieldset>
			<br>
