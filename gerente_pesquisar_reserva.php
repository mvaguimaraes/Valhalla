...
<div>
			...
			<form name="form1" method="post" action="gerente_pesquisar_reserva.php">
			<fieldset>
			...
			<fieldset>
				...
				<table id="tabelafundo"><form>
					...
					$query = mysql_query ("SELECT * FROM reservaatendente WHERE DataRequisitada between '$dataini' AND '$datafim' AND `Situacao` = 'Andamento';");
					...
					<tr>
						<td><a href="gerente_visualizar_reserva_at.php?reservaatendente=<?php echo $row['CodReservaAtendente']?>" ><?php echo $row['CodReservaAtendente'];?></a></td>
