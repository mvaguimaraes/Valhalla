...
$result= mysql_query("SELECT * FROM  `cliente` WHERE  `Usuario` LIKE '$usuario'");

while($row= mysql_fetch_array($result))
{?>
	
	<form method="post" action="cliente_editar_cliente.php" >
    <input type="hidden" name="id" value="<?php echo $row['Usuario']; ?>" />
    <fieldset>
    <h1>Painel de Controle do Usu&aacute;rio</h1><br>
	<h2>Alterar Dados Cadastrais</h2><br>
    ...
    <h3>Dados Principais</h3><br><br>
				...
				CEP:<br>
				<input type="text" name="cep" value="<?php echo $row['CEP']; ?>" pattern="[0-9]{8}" maxlength="8" size="60" /><br /><br>
