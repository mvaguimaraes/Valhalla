...
<div>
			...
			<form name="form1" method="post" action="gerente_pesquisar_cliente.php">
			<fieldset>
				<h1>Pesquisar Cliente</h1><br><br>
				<!--<p>C&oacute;digo <input type="text" name="campocodigo" size="8" maxlength="10"/>
				<i>ou</i>-->
				<h3>Nome<input type="text" name="camponome" size="68" maxlength="250"/>
			...
			<fieldset>
				...
				<table id="tabelafundo"><form>
					...
					<?php
					$query = mysql_query ("SELECT * FROM cliente WHERE NomeCliente LIKE '%$camponome%'");
					...
					<tr>
						...
						<td><a href="gerente_visualizar_cliente.php?cliente=<?php echo $row['CodCliente']?>" ><?php echo $row['NomeCliente'];?></a></td>
						<td><?php echo $row['Email'];?></td>
						<td><?php echo $row['Usuario'];?></td>
						<!--<td align="center"><input type="submit" class="edita" name="enviar" value="Editar"/>
						<a href = "gerente_excluir_cliente.php"><input type="submit" value="Excluir"></td></a>-->
					</tr><?php } ?>
					</form>
					</table>
					</div>
