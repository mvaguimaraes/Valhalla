...
<?php
	...
	if (!$banco)
		...
		$query = mysql_query ("SELECT * FROM emprestimo WHERE CodEmprestimo =".$_GET['emprestimo']);
...
<fieldset>
    <h1>Visualizar Empr&eacute;stimo</h1><br><br>
    ...
    <br/>
			...
			<form name="form2" method="post" action="atendente_editar_emprestimo1.php">
			<input type="hidden" name="campocod" value=<?php echo $row['CodEmprestimo']?> >
			<input type="submit" value="Editar"></form>
			
			<form name="form3" method="post" action="atendente_excluir_emprestimo1.php">
			<input type="hidden" name="campocodigo" value=<?php echo $row['CodEmprestimo']?> >
