...
$result= mysql_query("SELECT * FROM  `filme` WHERE  `CodFilme` = $campocod");

while($row= mysql_fetch_array($result))
{?>
	
	<form method="post" action="atendente_editar_filme.php" enctype="multipart/form-data">
    <input type="hidden" name="id" value="<?php echo $row['CodFilme']; ?>" />
    <fieldset>
    <h1>Alterar Filme </h1><br><br>
    
				Nome:<br>
				<input type="text" name="nome" value="<?php echo $row['Nome']; ?>"  maxlength="60" size="60" /><br /><br>
				
				Data de Lan&ccedil;amento:<br>
				<input type="date" required name="data" value="<?php echo $row['DataLancamento']; ?>" pattern="[0-9]{8}"  maxlength="8" placeholder="AAAA/MM/DD (só numeros)"  /><br /><br>
				
				Produtora:<br>
				<input type="text" name="Produtora" value="<?php echo $row['Produtora']; ?>"  maxlength="60" size="60"/><br /><br>
				
				Diretor:<br>
				<input type="text" name="Diretor" value="<?php echo $row['Diretor']; ?>"  maxlength="60" size="60" /><br /><br>
				
				Pre&ccedil;o do Aluguel:<br>
				<select name="preco" value="<?php echo $row['Preco']; ?>">  
				...
				Elenco Principal:<br>
				<textarea name="elenco" rows="10" cols="60" value="<?php echo $row['ElencoPrincipal']; ?>" maxlength="60" placeholder="Digite aqui elenco principal..."></textarea><br><br />
				...
				M&iacute;dia:<br>
				<select name="midia" value="<?php echo $row['Midia']; ?>">  
					<option value="DVD">DVD</option>  
					<option value="Blu-Ray">Blu-Ray</option>  
				</select><br><br>
				
				Quantidade:<br>
				<input type="text" name="quantidade" value="<?php echo $row['Quantidade']; ?>"  maxlength="60" size="60" /><br /><br>
				
				Sinopse<br>
				<textarea name="sinopse" value="<?php echo $row['Sinopse']; ?>" rows="10" cols="60" placeholder="Digite aqui a sinopse do filme em quest&atilde;o..."></textarea><br><br />
    ...
    <a href="atendente_index.php"><input type="button"value="Cancelar"></a> 
    <br/><br/><br/>
    </fieldset>
