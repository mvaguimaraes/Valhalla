...
{
  echo "<script>alert('Usuario ja existe!');top.location.href='usuario_sem_login_cad_cliente.php';</script>";
} 
else{ 
	if($senha != $confsenha){
	echo "<script>alert('As senhas inseridas nao sao iguais!');top.location.href='usuario_sem_login_cad_cliente.php';</script>";
	}
...
echo "<script>alert('Seu cadastro foi realizado com sucesso!');top.location.href='usuario_sem_login_login.php';</script>";
}
}
