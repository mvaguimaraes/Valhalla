...
echo "<script>alert('Todos os exemplares desse filme ja foram reservados para esse dia!');top.location.href='atendente_index.php';</script>";
}
...
echo "<script>alert('Sua reserva foi realizada com sucesso!');top.location.href='atendente_index.php';</script>";
