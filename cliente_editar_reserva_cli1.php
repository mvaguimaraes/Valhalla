...
$result= mysql_query("SELECT * FROM  `reservacliente` WHERE  `CodReservaCliente` = $campocod");

while($row= mysql_fetch_array($result))
{?>
	
	<form method="post" action="cliente_editar_reserva_cli.php" >
    <input type="hidden" name="id" value="<?php echo $row['CodReservaCliente']; ?>" />
    <fieldset>
    <h1>Editar Reserva Cliente </h1><br><br>
				...
				<?php echo $row['DataFeitaReserva'];?><br /><br><br>	
    ...
    <a href="cliente_index.php"><input type="button"value="Cancelar"></a> 
    <br/><br/><br/>
    </fieldset>
