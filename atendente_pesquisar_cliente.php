...
<div>
			...
			<form name="form1" method="post" action="pesquisar_cliente.php">
			<fieldset>
			...
			<fieldset>
				...
				<table id="tabelafundo"><form>
					...
					<tr>
						...
						<td><a href="atendente_visualizar_cliente.php?cliente=<?php echo $row['CodCliente']?>" ><?php echo $row['NomeCliente'];?></a></td>
